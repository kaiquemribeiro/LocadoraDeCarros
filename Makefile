...
saida: main.o alterarCliente.o alterarLocadora.o atualizaAvaliacaoCliente.o avaliarLocadora.o cadastraCliente.o cadastraLocadora.o gravarCliente.o gravarLocadora.o gravarNewLogingInfo.o listarClientes.o listarLocadoras.o logAsNormalUser.o logAsRoot.o menuCliente.o menuLog.o menuRoot.o removerCliente.o removerLocadora.o setaCategoria.o tryLogin.o visualizaDadosCliente.o visualizarAvaliacoes.o listaLocadorasTexto.o listaClientesTexto.o geraArquivoTextoClientes.o geraArquivoTextoLocadoras.o
...
geraArquivoTextoClientes.o: geraArquivoTextoClientes.c
	gcc -o geraArquivoTextoClientes.o -c geraArquivoTextoClientes.c

geraArquivoTextoLocadoras.o: geraArquivoTextoLocadoras.c
	gcc -o geraArquivoTextoLocadoras.o -c geraArquivoTextoLocadoras.c
...
listaLocadorasTexto.o: listaLocadorasTexto.c
	gcc -o listaLocadorasTexto.o -c listaLocadorasTexto.c

listarClientes.o: listarClientes.c
	gcc -o listarClientes.o -c listarClientes.c

listaClientesTexto.o: listaClientesTexto.c
	gcc -o listaClientesTexto.o -c listaClientesTexto.c
