...
#define MAX_LOCADORAS 50             //número máximo de restaurants que podem ser cadastrados
#define MAX_CLIENTES 50              //número máximo de clientes cadastrados
#define MAX_LOCADORAS_POR_CLIENTE 50 //número de restaurantes por cliente
